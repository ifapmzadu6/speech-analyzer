...
void showClustering(std::vector<double>& input, int samplingSize)
{
    ...
    Gnuplot<double>::Output2DToGnuplot(inputCycles, "inputCycles",
        "w l lc rgb '#E0FF0000'");
    ...
    if (true) {
        ...
        Gnuplot<int>::OutputToGnuplot(result.indexOfCluster,
    ...
    std::vector<double>& julius)
{
    ...
    Gnuplot<double>::Output2DToGnuplot(
    ...
    Gnuplot<double>::OutputToGnuplot(defaultWave, gnuplotSubtitle + "defaultWave",
        "w l");
    ...
    if (true) {
        ...
        Gnuplot<double>::OutputToGnuplot(gnuplot2, gnuplotSubtitle + "gnuplot2",
            "w l");
    }
}
